...
public sealed class CountryCode : ValueObject
{
    ...
    private static readonly FrozenSet<string> IsoAlpha2Codes = new[]
    {
    ...
    public static Result<CountryCode> Create(string? value)
    {
        ...
        {
            return ProfileErrors.CountryCodeInvalid;
        }

        string normalized = value.Trim().ToUpperInvariant();

        return IsoAlpha2Codes.Contains(normalized)
            ? new CountryCode(normalized)
            : ProfileErrors.CountryCodeInvalid;
    }
